...
namespace satdump
{
    ...
    private: // Rotator control
        ...
        SatAzEl rot_current_req_vel;

        std::mutex rotator_handler_mtx;
        std::shared_ptr<rotator::RotatorHandler> rotator_handler;

        double rotator_correction_az = 0;
        double rotator_correction_el = 0;
        double rotator_correction_el_dir = 0;
        float az_delta = 0;
        float el_delta = 0;
        float time_delta = 0;
